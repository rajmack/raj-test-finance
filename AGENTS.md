...
Plain-English personal financial blueprint builder: visitors enter income/expenses/assets/liabilities, see a live summary, generate a blueprint report, and pay ₹299 via Stripe to unlock the full report.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "178760946+rajmack@users.noreply.github.com"
  git config user.name "rajmack"
  ```
